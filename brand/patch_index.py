...
HEAD = """  <title>Muchat</title>
  ...
  <link rel="stylesheet" href="/muchat-brand/boot.css?v=12">
  <script src="/muchat-brand/boot.js?v=12" defer></script>
"""
...
def patch(html: str) -> str:
    ...
    if "/muchat-brand/boot.js" in html:
        html = html.replace("boot.css?v=11", "boot.css?v=12")
        html = html.replace("boot.js?v=11", "boot.js?v=12")
        return html
