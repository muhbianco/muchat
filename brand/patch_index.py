...
HEAD = """  <title>Muchat</title>
  ...
  <link rel="stylesheet" href="/muchat-brand/boot.css?v=16">
  <script src="/muchat-brand/boot.js?v=16" defer></script>
"""
...
def patch(html: str) -> str:
    ...
    if "/muchat-brand/boot.js" in html:
        html = html.replace("boot.css?v=15", "boot.css?v=16")
        html = html.replace("boot.js?v=15", "boot.js?v=16")
        return html
