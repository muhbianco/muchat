...
HEAD = """  <title>Muchat</title>
  ...
  <link rel="stylesheet" href="/muchat-brand/boot.css?v=13">
  <script src="/muchat-brand/boot.js?v=13" defer></script>
"""
...
def patch(html: str) -> str:
    ...
    if "/muchat-brand/boot.js" in html:
        html = html.replace("boot.css?v=12", "boot.css?v=13")
        html = html.replace("boot.js?v=12", "boot.js?v=13")
        return html
