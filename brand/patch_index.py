...
HEAD = """  <title>Muchat</title>
  ...
  <link rel="stylesheet" href="/muchat-brand/boot.css?v=24">
  <script src="/muchat-brand/boot.js?v=24" defer></script>
"""
...
def patch(html: str) -> str:
    ...
    if "/muchat-brand/boot.js" in html:
        html = html.replace("boot.css?v=20", "boot.css?v=24")
        html = html.replace("boot.js?v=20", "boot.js?v=24")
        html = html.replace("boot.css?v=21", "boot.css?v=24")
        html = html.replace("boot.js?v=21", "boot.js?v=24")
        html = html.replace("boot.css?v=22", "boot.css?v=24")
        html = html.replace("boot.js?v=22", "boot.js?v=24")
        html = html.replace("boot.css?v=23", "boot.css?v=24")
        html = html.replace("boot.js?v=23", "boot.js?v=24")
        return html
