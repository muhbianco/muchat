...
HEAD = """  <title>Muchat</title>
  ...
  <link rel="stylesheet" href="/muchat-brand/boot.css?v=9">
  <script src="/muchat-brand/boot.js?v=9" defer></script>
"""
...
def patch(html: str) -> str:
    ...
    if "/muchat-brand/boot.js" in html:
        html = html.replace("boot.css?v=8", "boot.css?v=9")
        html = html.replace("boot.js?v=8", "boot.js?v=9")
        return html
