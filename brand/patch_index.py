...
HEAD = """  <title>Muchat</title>
  ...
  <link rel="stylesheet" href="/muchat-brand/boot.css?v=17">
  <script src="/muchat-brand/boot.js?v=17" defer></script>
"""
...
def patch(html: str) -> str:
    ...
    if "/muchat-brand/boot.js" in html:
        html = html.replace("boot.css?v=16", "boot.css?v=17")
        html = html.replace("boot.js?v=16", "boot.js?v=17")
        return html
