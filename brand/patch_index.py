...
HEAD = """  <title>Muchat</title>
  ...
  <link rel="stylesheet" href="/muchat-brand/boot.css?v=8">
  <script src="/muchat-brand/boot.js?v=8" defer></script>
"""
...
def patch(html: str) -> str:
    ...
    if "/muchat-brand/boot.js" in html:
        html = html.replace("boot.css?v=7", "boot.css?v=8")
        html = html.replace("boot.js?v=7", "boot.js?v=8")
        return html
